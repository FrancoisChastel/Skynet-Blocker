...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_artonge_go_csv_tag",
        importpath = "github.com/artonge/go-csv-tag",
        sum = "h1:yaYWPTgSPx0em0q9weWCbOdF6WD/gyp0x/pWkTBel1Y=",
        version = "v1.0.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_masatana_go_textdistance",
        importpath = "github.com/masatana/go-textdistance",
        sum = "h1:Pz8zZjVRvKxISYimNzLGnzSNl5hYXFSN80FPQ+qt1HE=",
        version = "v0.0.0-20191005053614-738b0edac985",
    )
    go_repository(
        name = "com_github_olivere_elastic",
        importpath = "github.com/olivere/elastic",
        sum = "h1:UfSGJem5czY+x/LqxgeCBgjDn6St+z8OnsCuxwD3L0U=",
        version = "v6.2.37+incompatible",
    )
    go_repository(
